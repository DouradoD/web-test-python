import pytest
from tests.config.session_info import get_execution_data
from tests.config.remote import driver_factory
...
class Hooks:
    ...
    def driver(self):
        """ Fixture to provide the automation_core.Remote object all set for running the tests. """
    ...
    def pytest_bdd_before_scenario(self):
        self._driver.maximize_window()

    def pytest_bdd_after_scenario(self, request):
